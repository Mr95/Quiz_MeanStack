MyApp.controller('quizController',['$scope','quizService','$interval' , 'historiqueService',function($scope , quizService , $interval , historiqueService){
  ...
  var obj = JSON.parse(localStorage.getItem('user'));
    ...
    //recupération des themes pour afficher dans les options de le select
    quizService.getThemes().then(function(response){
    ...
    $scope.next_quiz = function(){
        ...
        if($scope.current_quiz >= 5){
          ...
          if($scope.level == 'facile'){
            ...
            if(totalSeconds <= 20){
              $scope.score = nbcorrectAnswer * 20 ;
              historiqueService.saveHistorique(JSON.stringify(new Date()) , nbcorrectAnswer ,totalSeconds, $scope.score); 
            }else{
              $scope.score = nbcorrectAnswer * 10 ;
              historiqueService.saveHistorique(JSON.stringify(new Date()) , nbcorrectAnswer ,totalSeconds, $scope.score); 
            }
